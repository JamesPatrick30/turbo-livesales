...
// ── Mock Performance Stats (Matching Admin Card Aesthetics) ────────────────
// const KITCHEN_STATS = [
//   { label: "Orders Fulfilled", value: "87", sub: "Today's total" },
//   { label: "Avg. Prep Time", value: "11.4m", sub: "Target: < 15m" },
//   { label: "Peak Speed Hour", value: "12 PM", sub: "Avg. 8.2m per order" },
// ];

// ── Mock Completed Orders (Aligned with Prisma Schema) ──────────────────────
            ...
            <div className="divide-y divide-white/5">
              {completedOrders.map((order) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-4 min-w-45">
                    <div>
                      <span className="text-base font-bold tracking-tight text-white block">
                        #{order.receiptNo}
                      </span>
                      <span className="text-xs text-neutral-600 block mt-0.5 tabular-nums">
                        Ready {handleReadyOrderTime(order.readyAt)}
                      </span>
                  ...
                  <div className="flex items-center justify-between lg:justify-end gap-6 min-w-50">
