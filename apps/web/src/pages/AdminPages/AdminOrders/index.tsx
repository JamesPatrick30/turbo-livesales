            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/5">
                  <th className="text-left px-5 py-3 text-xs text-neutral-600 font-medium">Order</th>
                  <th className="text-left px-5 py-3 text-xs text-neutral-600 font-medium">Table</th>
              ...
              <tbody>
                {ORDERS.map((order) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-xs text-neutral-500 max-w-xs truncate">{order.items}</td>
                    <td className="px-5 py-3.5 text-xs text-neutral-600">{order.time}</td>
                    <td className="px-5 py-3.5 text-sm font-medium text-white">{order.total}</td>
                    <td className="px-5 py-3.5">
                      <span className={`text-xs px-2.5 py-1 rounded-full font-medium capitalize ${STATUS_STYLES[order.status]}`}>
                        {order.status}
                      </span>
                    </td>
                  </tr>
